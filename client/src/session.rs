...
impl Session {
    ...
    pub fn signup(&mut self, name: String, user: String, pass: String) -> Result<(), SessionError> {
        let body = BaseModels::User::full(name, user, pass);

        let packet = Packet::new(PacketType::Register, body);
